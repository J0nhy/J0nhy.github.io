		  ...
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   ...
				   <h4 class="box-link"><a href="manage_categories.php">Adicionar Categorias</a> </h4>
				</div>
				<div class="card-body--">
						 ...
						 <tbody>
							...
							<tr>
							   ...
							   <td>
								...
								echo "<span class='badge badge-edit'><a href='manage_categories.php?id=".$row['id']."'>Editar</a></span>&nbsp;";
